...
export interface ApiClientIntakeFormClientIntakeForm
  ...
  info: {
    ...
    pluralName: 'client-intake-forms';
    singularName: 'client-intake-form';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    details_of_damage: Schema.Attribute.Text & Schema.Attribute.Required;
    email: Schema.Attribute.Email & Schema.Attribute.Required;
    full_name: Schema.Attribute.String & Schema.Attribute.Required;
    insurance_comapany: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::client-intake-form.client-intake-form'
    > &
      Schema.Attribute.Private;
    phone: Schema.Attribute.String & Schema.Attribute.Required;
    policy_number: Schema.Attribute.String;
    property_address: Schema.Attribute.Text & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    type_of_damage: Schema.Attribute.Text & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiContactInformationContactInformation
  ...
  attributes: {
    ...
    phone: Schema.Attribute.String & Schema.Attribute.Required;
    phone_numbers: Schema.Attribute.JSON & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomeHeroSectionHomeHeroSection
  ...
  attributes: {
    ...
    main_heading: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    secondary_description: Schema.Attribute.Text & Schema.Attribute.Required;
    secondary_heading: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomeInsuranceOurProcessHomeInsuranceOurProcess
  extends Struct.CollectionTypeSchema {
  collectionName: 'home_insurance_our_processes';
  info: {
    displayName: 'Home-Insurance-Process';
    pluralName: 'home-insurance-our-processes';
    singularName: 'home-insurance-our-process';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    bottom_description: Schema.Attribute.Text & Schema.Attribute.Required;
    bottom_heading: Schema.Attribute.String & Schema.Attribute.Required;
    claim_services: Schema.Attribute.Component<'services.claim-services', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-insurance-our-process.home-insurance-our-process'
    > &
      Schema.Attribute.Private;
    our_process: Schema.Attribute.Component<'services.claim-services', true>;
    publishedAt: Schema.Attribute.DateTime;
